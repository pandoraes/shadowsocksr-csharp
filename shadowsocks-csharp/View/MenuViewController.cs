...
namespace Shadowsocks.View
{
    public class MenuViewController
    {
        ...
        private void LoadMenu()
        {
            this.contextMenu1 = new ContextMenu(new MenuItem[] {
                modeItem = CreateMenuGroup("Mode", new MenuItem[] {
                    ...
                    PACModeItem = CreateMenuItem("Enable PAC", new EventHandler(this.PACModeItem_Click)),
                    globalModeItem = CreateMenuItem("Enable Global", new EventHandler(this.GlobalModeItem_Click))
                }),
                ...
                new MenuItem("-"),
                CreateMenuGroup("Configure", new MenuItem[] {
        ...
        {
            controller.UpdatePACFromOnlinePac("https://raw.githubusercontent.com/pandoraes/shadowsocksr-csharp/master/gfw/ss_lanip.pac");
        }

        private void UpdatePACFromCNWhiteListItem_Click(object sender, EventArgs e)
        {
            controller.UpdatePACFromOnlinePac("https://raw.githubusercontent.com/pandoraes/shadowsocksr-csharp/master/gfw/ss_white.pac");
        }

        private void UpdatePACFromCNOnlyListItem_Click(object sender, EventArgs e)
        {
            controller.UpdatePACFromOnlinePac("https://raw.githubusercontent.com/pandoraes/shadowsocksr-csharp/master/gfw/ss_white_r.pac");
        }

        private void UpdatePACFromCNIPListItem_Click(object sender, EventArgs e)
        {
            controller.UpdatePACFromOnlinePac("https://raw.githubusercontent.com/pandoraes/shadowsocksr-csharp/master/gfw/ss_cnip.pac");
        }
